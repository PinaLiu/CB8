...
export default function PrivacyPolicy() {
  return (
    <div className={styles.privacy}>
      ...
      <p>
        1. In questa sezione sono contenute le informazioni relative alle
        modalità di gestione di ____________ in riferimento al trattamento dei
        dati degli utenti di __________.
      </p>
      <p>
        2. La presente informativa ha valore anche ai fini dell’art. 13 del
        D.lgs. n. 196/2003, Codice in materia di protezione dei dati personali,
        e ai fini dell’art. 13 del Regolamento UE n. 2016/679, relativo alla
        protezione delle persone fisiche con riguardo al trattamento dei dati
        personali nonché alla libera circolazione di tali dati, per i soggetti
        che interagiscono con _______________ ed è raggiungibile all’indirizzo
        corrispondente alla pagina iniziale: _____________
      </p>
      <p>
        3. L’informativa è reale solo per _______________ e non anche per altri
        siti web eventualmente consultati dall’utente tramite link in esso
        contenuti.
      </p>
      <p>
        4. Scopo del presente documento è fornire indicazioni circa le modalità,
        ...
        di _______________, indipendentemente dagli scopi del collegamento
        stesso, secondo la legislazione Italiana ed Europea.
      </p>
      <p>
        5. L’informativa può subire modifiche a causa dell’introduzione di nuove
        norme al riguardo, si invita, pertanto, l’utente a controllare
        periodicamente la presente pagina.
      </p>
      <p>
        6. Se l’utente ha meno di sedici anni, ai sensi dell’art. 8, c. 1
        regolamento UE 2016/679, dovrà legittimare il suo consenso attraverso
        l’autorizzazione dei genitori o di chi ne fa le veci.
      </p>
      ...
      <p>
        ...
        altri, determina le finalità e i mezzi del trattamento di dati
        personali. Si occupa anche dei profili sulla sicurezza.
      </p>
      <p>
        2. Relativamente al presente sito web il titolare del trattamento è
        ____________ e per ogni chiarimento o esercizio dei diritti dell’utente
        potrà contattarlo al seguente indirizzo mail: _____________________
      </p>
      <p>2. Responsabile del trattamento dei dati</p>
      <p>
      ...
      <p>
        2. Ai sensi dell’articolo 28 del Regolamento UE n. 2016/679, su nomina
        del titolare dei dati, il responsabile del trattamento dei dati del sito
        _______________ è: _____________________
      </p>
      <p>3. Luogo trattamento dati</p>
      <p>
        1. Il trattamento dei dati generato dall’utilizzo di
        _____________avviene presso ___________ in via ____________
      </p>
      <p>
        2. In caso di necessità, i dati connessi al servizio newsletter possono
        essere trattati dal responsabile del trattamento o soggetti dati esso
        incaricati a tal fine presso la relativa sede.
      </p>

      <h2>III - Cookies</h2>
      <h4>1. Tipo di cookies</h4>
      <p>
        1. Il sito ______________ utilizza cookies per rendere l’esperienza di
        navigazione dell’utente più facile ed intuitiva...
      </p>
      <p>
        2. Un cookie consiste in un ridotto insieme di dati trasferiti al
        ...
        eseguibile e non trasmette virus.
      </p>
      <p>
        3. I cookies non registrano alcuna informazione personale e gli
        eventuali dati identificabili non verranno memorizzati. Se si desidera,
        è possibile impedire il salvataggio di alcuni o tutti i cookies.
      ...
      <p>
        1. Ci sono numerose tecnologie usate per conservare informazioni nel
        computer dell’utente, che poi vengono raccolte da altri siti. Tra queste
        la più conosciuta ed utilizzata è HTML. Essi servono per la navigazione
        e per facilitare l’accesso e la fruizione del sito da parte dell’utente.
        Sono necessari alla trasmissione di comunicazioni su rete elettronica
        ovvero al fornitore per erogare il servizio richiesto dal cliente.
      </p>
      <p>
        2. Le impostazioni per gestire o disattivare i COOKIES possono variare a
      ...
      <p>
        3. L’uso dei cookies tecnici consente la fruizione sicura ed efficiente
        del sito.
      </p>
      <p>
        4. I COOKIES che vengono inseriti nel browser e ritrasmessi mediante
        Google Analytics o tramite il servizio statistiche di blogger o similari
        sono tecnici solo se utilizzati ai fini di ottimizzazione del sito
        direttamente dal titolare del sito stesso, che potrà raccogliere
        informazioni in forma aggregata soul numero degli utenti e su come
        questi visitano il sito. A queste condizioni, per i COOKIES Analytics
        valgono le stesso regole, in tema di informativa e consenso, previste
        per i cookies tecnici.
      </p>
      <p>
        5. Dal punto di vista della durata si possono distinguere cookies
      ...
      <p>
        6. Potranno essere installati cookies di sessione al fine di consentire
        l’accesso e la permanenza nell’area riservata del portale come utente
        autenticato.
      </p>
      <p>
        7. Essi non vengono memorizzati in modo persistente ma esclusivamente
      ...
      <p>
        1. In relazione alla provenienza si distinguono i cookies inviati al
      ...
      <p>
        3. La maggior parte dei cookies di terse parti è costituita da cookies
      ...
      <p>
        4. Potranno essere installati cookies di terze parti analitici. Essi
        sono inviati da domini di predette terze parti esterni al sito.
      </p>
      <p>
        5. I cookies analitici di terze parti sono impiegati per rilevare
        informazioni soul comportamento degli utenti su _____________. La
        ...
        su ______________, al fine di proporre messaggi pubblicitari in linea
        con le scelte manifestate degli utenti medesimi.
      </p>
      <p>
        6. L’utilizzo di questi cookies è disciplinato dalle regole predisposte
      ...
      <p>
        1. Sono cookies di profilazione quelli a creare profili all’utente e
        vengono utilizzati al fine di inviare messaggi pubblicitari in linea con
        le preferenze manifestate dallo stesso nell’ambito della navigazione in
        rete.
      </p>
      <p>
        2. Quando si utilizzeranno questi tipi di COOKIES l’utente dovrà dare un
        consenso esplicito.
      </p>
      <p>
        3. Si applicherà l’articolo 22 del Regolamento UE 2016/679 e l’articolo
        122 del Codice in materia di protezione dei dati.
      </p>
      ...
      <p>
        2. Le suddette informazioni sono test rate in forma automatizzata e
      ...
      <p>
        3. Ai fini di sicurezza (filtri anti-spam, firewall, rilevazione virus)
        i dati registrati automaticamente possono eventualmente comprendere
        anche dati personali come l’indirizzo IP, che potrebbe essere
        utilizzato, conformemente alle leggi vigenti in materia, a fine di
        bloccare tentativi di danneggiamento al sito medesimo o di recare danno
        ad altri utenti o attività dannose o costituenti reato. Tali dati non
        sono mai utilizzati per l’identificazione o la profilazione dell’utente,
        ma solo ai fini di tutela del sito e dei suoi utenti, tali informazioni
        saranno usate in base ai legittimi interessi del titolare.
      </p>
      <p>
        4. Qualora il sito consenta l’inserimento di commenti, oppure in caso di
      ...
      <p>
        1. I dati raccolti dal sito durante il suo funzionamento sono utilizzati
        esclusivamente per le finalità sopra indicate e conservati per il tempo
        strettamente necessario a svolgere le attività precisate e, comunque,
        non oltre 2 anni.
      </p>
      <p>
        2. I dati utilizzati ai fini di sicurezza (blocco tentativi di
      ...
      <h4>
        1. L’art. 13 co. 2 del Regolamento UE del 2016/679 elenca i diritti
        dell’utente.
      </h4>
      <p>
        2. Il presente sito _____________ intende, pertanto, informare l’utente
        sull’esistenza:
      </p>
      <ul>
        <li>
          del diritto dell’interessato di chiedere al titolare l’accesso ai dati
          personali (art. 15 Regolamento UE), il loro aggiornamento (art. 7, co.
          3, lett. a del D.lgs 196/2003), la rettifica (art. 16 Regolamento UE),
          l’integrazione (art. 7, co. 3 lett. a D.lgs 196/2003), la limitazione
          del trattamento che lo riguardino (art. 18 Regolamento UE) o di
          opporsi, per motivi legittimi, al loro trattamento (art. 21
          Regolamento UE), oltre al diritto alla portabilità dei dati (art. 20
          Regolamento UE);
        </li>
        <li>
          del diritto di chiedere la cancellazione (art. 17 Regolamento UE), la
          ...
          raccolti o successivamente trattati (art. 7 co. 3, lett. b del D.lgs.
          196/2003);
        </li>
        <li>
          del diritto di ottenere l’attestazione che le operazioni di
          ...
          manifestamente sproporzionato rispetto al diritto tutelato (art. 7 co.
          3, lett. c del D.lgs 196/2003).
        </li>
      </ul>
      <p>
        3. Le richieste possono essere indirizzate al titolare del trattamento
        al suo indirizzo email summenzionato (senza formalità) oppure
        utilizzando il modello previsto dal Garante per la protezione dei dati
        personali.
      </p>
      <p>
        4. Qualora il trattamento sia basato sull’art. 6 paragrafo 1 lettera a –
        consenso espresso all’utilizzo – oppure sull’art. 9 paragrafo 2 lettera
        a – consenso espresso all’utilizzo di dati genetici, biometrici,
        relativi alla salute, che rivelino convinzioni religiose, filosofiche o
      ...
      <p>
        5. Parimenti, in caso di violazione della normativa, l’utente ha il
      ...
      <p>
        6. Per una disamina più approfondita dei diritti che Le competono, si
      ...
      <ul>
        ...
        <li>
          ...
          ai fini di procreazione assistita, prestazione di servizi sanitari per
        ...
        <li>
          ...
          da associazioni, enti ed organismi senza scopo di lucro, anche non
        ...
        <li>
          ...
          il profilo o la personalità dell’interessato o ad analizzare abitudini
          e scelte di consumo ovvero a monitorare l’utilizzo di servizi di
        ...
        <li>
          dati registrati in apposite banche dati gestite con strumenti
      ...
      <h2>VII – SICUREZZA DEI DATI FORNITI</h2>
      <h4>
        1. Il presente sito tratta i dati degli utenti in maniera lecita e
      ...
      <p>
        2. Oltre al titolare, in alcuni casi, potrebbero avere accesso ai dati
        categorie di incaricati coinvolti nell’organizzazione del sito
        (personale amministrativo, marketing, commerciale, legali,
        amministratori di sistema) ovvero soggetti esterni come (come fornitori
        di servizi tecnici terzi, corrieri postali, hosting provider, società
      ...
      <p>
        2. Esso può essere soggetto a modifiche o aggiornamenti. Qualora si
        tratti di modifiche e aggiornamenti rilevanti questi saranno segnalati
        con apposite notifiche agli utenti.
      </p>
      <p>
        3. Le versioni precedenti del documento saranno consultabili, comunque,
        a questa pagina.
      </p>
      <p>
        4. Il documento è stato aggiornato in data ________ per essere conforme
        alle disposizioni normative in materia ed in particolare al Regolamento
        UE 2016/679.
      </p>
    </div>
  );
