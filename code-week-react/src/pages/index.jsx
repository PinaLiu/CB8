    ...
    <>
      <Layout>
        <div className="header">
          <h2>Crea la TUA Pizza</h2> <p>In 3 passaggi crea la tua pizza.</p>
          <p>Scegli l’impasto, la base e la farcitura.</p>
        </div>

        <div className="container-main ">
          <img
            className="description animation move no-display shadow"
            src="https://img.freepik.com/premium-vector/doodle-number-one-background-cream_409898-385.jpg"
            alt="1"
          />
          <div className="description animation move ">
            <h4>SCEGLI L’IMPASTO</h4>
            <p>Scegli l’impasto della tua pizza tra:</p>
            <ul>
              <li>Tradizionale</li>
              <li>Semi e ceriali</li>
              <li>Tumminia</li>
            </ul>
          </div>
          <img
            className="description animation move no-display"
        ...
        <div className="container-main">
          ...
          <div className="description">
            ...
            <p>Scegli la base della tua pizza tra: </p>
            <ul>
              <li>margherita </li>
              <li>bianca</li>
              <li>rossa</li>
        ...
        <div className="container-main">
          ...
          />
          <div className="description">
            <h4>SCEGLI I TOPPINGS</h4>
            <p>Scegli come farcire la tua pizza:</p>
            {/* inserire i vari ingredienti da includere nella pizza */}
            <ul>
              <li>vari ingredienti</li>
              <li>vari ingredienti</li>
              <li>vari ingredienti</li>
            </ul>
          </div>
